...
(function(b) {
    ...
    b.modal.impl = {
        ...
        init: function(a, h) {
            ...
            this.occb = !1;
            if ("object" === typeof a) {
                if (a = a instanceof b ? a: b(a), this.d.placeholder = !1, 0 < a.parent().parent().size() && (a.before(b("<span></span>").attr("id", "simplemodal-placeholder").css({
                    display: "none"
            ...
            $("#simplemodal-container").draggable({handle: "div.titlebar"});
            return this
        },
        create: function(a) {
            this.getDimensions();
        ...
        fixIE: function() {
            ...
            b.each([this.d.iframe || null, !this.o.modal ? null: this.d.overlay, "fixed" === this.d.container.css("position") ? this.d.container: null],
            function(b, e) {
                if (e) {
                    var f = e[0].style;
                    f.position = "absolute";
                    if (2 > b) f.removeExpression("height"),
        ...
        setContainerDimensions: function() {
            ...
            this.d.wrap.css({
                overflow: e > b || f > a ? "visible": "visible"
            });
