        ...
        me.tbar = ['Search',{
                ...
                scope: me
					...
					listeners: {
				        click: function(){
				        		var month = Ext.util.Format.date(Ext.getCmp("month").getValue(), 'Y-m') + '-01';
								//url: "qam_metricsdata_ajax.cgi?project_id=[% project_id %]&type=export&month=2012-01-01"
								window.open("qam_metricsdata_ajax.cgi?project_id=[% project_id %]&type=export&month="+month);
				      		}
				     }
				}];
